...
Not surprisingly there are less nature-based tweets than nature-based. Of all `r nrow(nature_df)` tweets, `r nrow(nature_df %>% filter(nature_word == 1))/nrow(data)*100`% are nature-based. 
